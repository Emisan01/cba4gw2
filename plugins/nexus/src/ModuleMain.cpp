...
#ifdef CBA_LOCAL_DEV
	// Build=hour, Revision=minute*100+second of the actual compile - lets
	// Nexus's displayed version number prove which build is really loaded,
	// instead of eyeballing file sizes/timestamps (see CLAUDE.md 2026-09-09).
	// Regenerated by CMake's cba_gen_buildstamp target on every build.
